...
const Content = () => (
  <div className="row">
    <div style={{ marginLeft: '20%' }} className="col-md-8">
      <h4 style={{ fontWeight: 400, fontSize: '1.5em' }}>Here's a time line of Dr. Borlaug's life:</h4>
      <div>
      ...
      <blockquote className="blockquote">
        <p style={{ fontSize: '1em', fontWeight: 500 }}>"Borlaug's life and achievement are testimony to the far-reaching contribution that one man's towering intellect, persistence and scientific vision can make to human peace and progress."</p>
        <footer className="blockquote-footer">
          <cite>Indian Prime Minister Manmohan Singh</cite>
        </footer>
      </blockquote>
      <h4 style={{ fontWeight: 'normal' }}>If you have time, you should read more about this incredible human being on his <a href="https://en.wikipedia.org/wiki/Norman_Borlaug">Wikipedia entry.</a></h4>
    </div>
  </div>
);
